...
export interface ApiCursoCurso extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Creditos: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::curso.curso'> &
      Schema.Attribute.Private;
    Nombre_curso: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMatriculaMatricula extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fk_id_curso: Schema.Attribute.Relation<'oneToOne', 'api::curso.curso'>;
    fk_idEstudiante: Schema.Attribute.Relation<
      'oneToOne',
      'api::estudiante.estudiante'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
